...
public class CopyFileLogEntryV2() : LogEntry("Copy a file")
{
    [JsonPropertyOrder(3)] 
    ...
    public CopyFileLogEntryV2(string backupName, string sourcePath, string destinationPath, long fileSize, double transferTimeMs, double encryptionTimeMs) : this()
    {
